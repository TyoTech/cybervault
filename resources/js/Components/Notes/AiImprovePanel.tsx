        ...
        <div className="mb-6 space-y-4">
            ...
            {suggestion && (
                <div className="rounded-md border border-accent/30 bg-surface p-4 space-y-4">
                    ...
                    <div>
                        <p className="text-xs uppercase tracking-wide text-faint mb-1">Content</p>
                        {/* Output AI = untrusted: sanitasi DOMPurify sebelum render preview. */}
                        <div
                            className="ai-preview text-sm text-body leading-relaxed space-y-2"
                    ...
                    {suggestion.suggestions.length > 0 && (
                        <div>
                            <p className="text-xs uppercase tracking-wide text-faint mb-1">Suggestions</p>
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-edge">
                        <p className="text-xs text-faint">
                            Accept hanya mengisi editor. Tekan <span className="text-body">Update (.docx)</span> untuk menyimpan.
                        </p>
