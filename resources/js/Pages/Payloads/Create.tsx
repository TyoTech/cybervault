        ...
        <AuthenticatedLayout header="Tambah Payload">
            ...
            <form onSubmit={submit} className="space-y-6 max-w-2xl">
                ...
                <div>
                    ...
                    <textarea value={data.content} onChange={(e) => setData('content', e.target.value)} className="w-full h-48 rounded-md border border-white/10 bg-zinc-900/50 p-4 text-sm text-zinc-100 font-mono outline-none resize-y" required />
