...
import { Search, Plus, Terminal, Edit, Trash2 } from 'lucide-react';
                ...
                <div className="flex-1 w-full space-y-4">
                    {filteredPayloads.length === 0 ? (
                        <EmptyState
                            ...
                            description="Belum ada payload yang tersimpan di kategori ini."
                        />
                    ) : (
                            ...
                            <Card key={payload.id} className="group border-white/5">
                                <CardContent className="p-5">
                                    ...
                                    <div className="mt-4 relative group/code">
                                        <div className="bg-[#0d0d0d] border border-white/10 rounded-lg p-4 font-mono text-sm text-zinc-300 overflow-x-auto break-all">
                                            {payload.content}
                                        </div>
                                        <div className="absolute top-2 right-2 opacity-0 group-hover/code:opacity-100 transition-opacity">
                                            <CopyButton value={payload.content} />
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
