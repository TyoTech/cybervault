...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/challenges/ai/assist', [App\Http\Controllers\ChallengeController::class, 'assistStructured'])
    ...
    Route::patch('/settings/storage', [SettingsController::class, 'updateStorage'])
